import 'package:ewallet/src/models/hex_color.dart';
import 'package:ewallet/src/widget/cards.dart';
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        CreditCard(color: "2a1214", number: 9290, image: "assets/images/master.png", valid: "VALID 10/22",),
                        CreditCard(color: "000068", number: 1298, image: "assets/images/visa.png", valid: "VALID 07/24",),
                      ],
                    ),
                  ),
                  SizedBox(height: 5,),
                  ...
                  Container(
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          padding: const EdgeInsets.all(2.0),
                          child: CircleAvatar(backgroundImage: AssetImage("assets/images/p2.jpg"),),
                        ),
                        Padding(
                          padding: const EdgeInsets.all(2.0),
                          child: CircleAvatar(backgroundImage: AssetImage("assets/images/p3.jpg"),),
                        ),
                        Padding(
                          padding: const EdgeInsets.all(2.0),
                          child: CircleAvatar(backgroundImage: AssetImage("assets/images/p1.jpg"),),
                        ),
                      ],
                    ),
                  ),
                  ...
                  ListTile(
                    ...
                    leading: CircleAvatar(backgroundImage: AssetImage("assets/images/p3.jpg"),),
            ...
            child: new Wrap(
              children: <Widget>[
                ...
                Row(
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: CircleAvatar(radius: 25,backgroundImage: AssetImage("assets/images/p2.jpg"),),
                  ),
                ],),
            Container(
